...
Post.prototype.validate = function() {
    if (this.data.title == "") this.errors.push("You must provide a tilte.");
...
Post.prototype.actuallyUpdate = function() {
    return new Promise(async (resolve, reject) => {
        ...
        this.validate();
        if (!this.errors.length) {
            await postsCollections.findOneAndUpdate({
...
Post.delete = function(postIdToDelete, currentUserId) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (post.isVisitorOwner) {
                await postsCollections.deleteOne({
...
Post.countPostsByAuthor = function(id) {
    return new Promise(async (resolve, reject) => {
        let postCount = await postsCollections.countDocuments({
            author: id
        });
        resolve(postCount);      
    });
...
Post.getFeed = async function(id) {
    ...
    let followedUsers = await followCollections.find({
