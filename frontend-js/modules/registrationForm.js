...
export default class RegistrationForm {
    ...
    usernameHandler() {
        ...
        this.username.timer = setTimeout(() => this.usernameAfterDeley(), 800);
    }
    ...
    emailHandler() {
        ...
        this.email.timer = setTimeout(() => this.emailAfterDeley(), 800);
    }
    ...
    passwordHandler() {
        ...
        this.password.timer = setTimeout(() => this.passwordAfterDeley(), 800);
    }
    ...
    formSubmitHandler() {
        this.usernameImmediately();
        this.usernameAfterDeley();
        this.emailAfterDeley();
        this.passwordImmediately();
        this.passwordAfterDeley();
